...
export default function Tile(
  props: { coords: { x: number; y: number }; mine: boolean, handleClick: (e: React.MouseEvent) => void;},
  ...
  return (
    ...
    >
      ...
      <span className="absolute invisible">x:{props.coords.x} y:{props.coords.y} <>{props.mine ? "mined" : <></>}</></span>
    </div>
  );
}
